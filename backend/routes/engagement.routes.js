...
router.post('/forums/:id/close', requireUserContext, engagementController.closeForum);
router.post('/forums/:id/reopen', requireUserContext, engagementController.reopenForum);
router.post('/forums/:id/best-answer', requireUserContext, engagementController.setBestAnswer);
