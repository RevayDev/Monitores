...
const statements = [
  ...
  `ALTER TABLE attendance ADD COLUMN modalidad VARCHAR(100)`,
  `ALTER TABLE attendance ADD COLUMN estado VARCHAR(100)`,
  ...
  `ALTER TABLE users ADD COLUMN tipo_monitor VARCHAR(50)`,
  `ALTER TABLE users ADD COLUMN tipo_soporte VARCHAR(50)`,
  ...
  `ALTER TABLE complaints ADD COLUMN tipo VARCHAR(100)`,
  `ALTER TABLE complaints ADD COLUMN reported_id INT`,
  `ALTER TABLE attendance ADD COLUMN comment TEXT NULL`,
  `ALTER TABLE attendance ADD COLUMN rating TINYINT NULL`,
  `ALTER TABLE users ADD COLUMN restrictions JSON NULL`,
  `ALTER TABLE academic_session_attendance ADD COLUMN comment TEXT NULL`,
